...
public final class APM {
    ...
    public static final String JOBS_DIRECTORY = "jobs_directory";
    ...
    public static final String BROWSER_PATHS = "browser_paths";

    // URLs
    public static final String APPLICATION_WEBSITE = "application_website";
    public static final String APPLICATION_USER_MANUAL = "application_user_manual";
    public static final String APPLICATION_FORUM = "application_forum";
    public static final String APPLICATION_SOURCEFORGE = "application_sourceforge";
}
